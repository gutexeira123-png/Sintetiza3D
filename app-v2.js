...
const viralMockData = {
  youtube: [
    ...
    { id: 'yt6', title: 'Montei um Negócio de Impressão 3D com R$500', creator: 'Empreenda 3D', views: '372K', emoji: '🚀', roteiro: '📌 Introdução: É possível começar com pouco? 🔍 Lista de equipamentos baratos. 💡 Estratégias para faturar rápido. 🎯 Resultados reais do primeiro mês.',
    ...
    { id: 'yt7', title: 'Os 5 Modelos 3D Grátis que Mais Vendi em 2025', creator: '3D Negócios', views: '256K', emoji: '🎯', roteiro: '📌 Introdução: Modelos grátis que geram lucro. 🔍 Onde encontrar cada um. 💡 Como customizar para vender. 🎯 Resultados financeiros.',
  ...
  tiktok: [
    ...
    { id: 'tt6', title: 'A melhor cor de filamento para vender 🔥', creator: '@vendas3d', views: '678K', emoji: '🎨', roteiro: '🎬 Gancho: cores que vendem mais. 🔍 Mostrar peças nas cores populares. 💡 Dados de vendas por cor. 🎯 Qual cor você mais vende?',
    ...
    { id: 'tt7', title: 'Nunca jogue fora peça com erro 🔄', creator: '@printsalvador', views: '523K', emoji: '🔄', roteiro: '🎬 Mostrar peça com defeito. 🔍 Técnicas de recuperação. 💡 Antes e depois surpreendente. 🎯 Economia e sustentabilidade.',
  ...
  instagram: [
    ...
    { id: 'ig6', title: 'Fiz meu próprio kit de ferramentas organizado 🧰', creator: '@organizacao3d', views: '94K', emoji: '🧰', roteiro: '📸 Estojo bagunçado vs organizado. 🔍 Mostrar divisórias e suportes impressos. 💡 STL disponível nos destaques. 🎯 Desafio: organize o seu também.',
    ...
    { id: 'ig7', title: 'Imprimi uma réplica exata do meu cachorro 🐕', creator: '@pet3dprint', views: '312K', emoji: '🐕', roteiro: '📸 Foto do cachorro real vs réplica impressa. 🔍 Processo de modelagem 3D. 💡 Impressão e pintura. 🎯 Reação emocionante do dono.',
  ...
  facebook: [
    ...
    { id: 'fb6', title: 'A verdade sobre filamento reciclado 🆘', creator: 'Sustentabilidade 3D', views: '43K', emoji: '🌱', roteiro: '📌 O problema do desperdício na impressão 3D. 🔍 Como o filamento reciclado é feito. 💡 Prós e contras reais. 🎯 Vale a pena para seu negócio?',
    ...
    { id: 'fb7', title: 'Como achei meu primeiro cliente sem gastar nada', creator: '3D na Prática', views: '81K', emoji: '🤝', roteiro: '📌 Comecei sem dinheiro para marketing. 🔍 Estratégias orgânicas que usei. 💡 O que funcionou e o que não funcionou. 🎯 Resultado: primeiros 10 clientes.',
